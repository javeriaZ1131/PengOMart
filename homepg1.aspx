	 ...
	 <script runat="server">
      ...
      <!--main-->
		  ...
		  <img src="images/main.jpg" class="img-fluid "alt="Pengonline Mart" >
			   ...
			   <img src="images/pengu1.jpg" class="img-fluid rounded-circle" padding:40px width: 20% alt=""></div>
        ...
        <a class="nav-link active rounded " href="#contact">CONTACT & INFO</a>
          ...
          <div class="navbar-nav ms-auto">
           ...
           <a class="nav-link active rounded" href="cart.aspx"><i class='fas fa-shopping-cart' style='font-size:24px'></i></a>
            ...
            <!--dropdown-->
         <div class=".dropdown ">
        <a href="#" class="nav-link active rounded dropdown-toggle" data-bs-toggle="dropdown"><i class='far fa-user-circle' style='font-size:24px'></i></a>
       
             <div class="dropdown-menu dropdown-menu-end">
            <a href="editmyaccount.aspx"  class="dropdown-item">Edit my account</a>
            <a href="#" class="dropdown-item">order History</a>
             <a href="#" class="dropdown-item">Track my Order</a>
        </div>
    </div>
</div>
</div>
...
<img src="images/meat%20and%20seafood.jpg" class="img-fluid" style= width:100% alt="">
                                     ...
                                     Button2_Click<asp:Button ID="Button3" runat="server" BackColor="#999999" OnClick="Button3_Click" Text="MEAT AND SEA FOODS" Width="207px" />
                         </button>
                        </div>
